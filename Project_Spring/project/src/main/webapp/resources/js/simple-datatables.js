                ...
                function (t, e, s) {
                    ...
                    class u {
                        ...
                        init(t) {
							...
							let cur =  window.localStorage.getItem("cur");  // localStorage 사용해서 값 저장
							...
							window.localStorage.setItem("cur", cur);
                                }, 10);
                        }
                        render(t) {
                            if (t) {
                            ...
                            if (
                                ...
                                e.perPage = Number(window.localStorage.getItem("perPage"));
                        ...
                        renderPage() {
                            ...
                            if (
                                ...
                                window.localStorage.setItem("cur", this.currentPage);
...
//                                            window.localStorage.setItem("selectlist", this.val());
											window.localStorage.setItem("perPage", t.perPage);
                                        },
                                        !1
                                    );
                            }
